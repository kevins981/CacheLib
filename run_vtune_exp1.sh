...
RESULT_DIR="/ssd1/songxin8/thesis/cache/vtune/exp1_64GBDIMMs/"
...
run_vtune () { 
  ...
  LD_PRELOAD=/usr/lib/x86_64-linux-gnu/debug/libstdc++.so.6.0.28 /opt/intel/oneapi/vtune/latest/bin64/vtune \
